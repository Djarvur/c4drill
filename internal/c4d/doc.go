...
// 35-01-PLAN.md) into a typed, comment/position-aware AST and onward into
// *parser.Model (D-21), wrapping all failures in the repo's standard
// *parser.ParseError contract.
//
...
// this package exposes the Parse/ParseFile Model-level entry points and the
// ParseAST/ParseASTFile AST-level entry points (ToModel converts between
// them).
package c4d
