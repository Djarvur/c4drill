...
Two deliberate boundaries: sibling and external boundary nodes stay at
the top level of the view (they are outside the depicted subtree), and
collapsed subtrees are not restructured — chains unfold only for the
elements a view actually depicts.
