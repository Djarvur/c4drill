...
- [x] **VIEW-01**: Generator creates C1 (Context) level view from model
- [x] **VIEW-02**: Generator creates C2 (Containers) level view for expanded systems
- [x] **VIEW-03**: Generator creates C3 (Components) level view for expanded containers
- [x] **VIEW-04**: Collapsed units render as single record shape
- [x] **VIEW-05**: Expanded units render as clusters with subunits inside
- [x] **VIEW-06**: View respects expanded list from properties and unit-level overrides
- [x] **VIEW-07**: Styling (color, border, style, edges) inherits from parent with override
...
- [x] **DEVI-05**: Modern Go plugin loaded via /use-modern-go before any development task
