...
- [x] 35-07-PLAN.md — CLI: .c4d render dispatch + convert subcommand with --follow-includes

**Wave 5** *(blocked on Wave 4 completion)*

- [x] 35-08-PLAN.md — fmt subcommand + comment-preserving TOML formatter

**Wave 6** *(blocked on Wave 5 completion)*

- [x] 35-09-PLAN.md — Docs, .c4d example twins, c4drill-toml skill extension
