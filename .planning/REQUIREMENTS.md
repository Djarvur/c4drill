...
- [ ] **VIEW-01**: C1 diagram shows only top-level units — no nested subunits appear as nodes
- [ ] **VIEW-02**: Links to deeply nested targets resolve to the nearest visible ancestor in the current view level
