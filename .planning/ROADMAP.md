...
- [x] **Phase 39: Edge Style Override (`--edges` CLI flag)** - Per-invocation edge routing override: persistent flag with loud enum validation, overriding the model `edges` property on every generated view, `--plain` interaction pinned, switch-matrix E2E, backward compat (completed 2026-08-31)
...
- [x] 39-03: Docs (README CLI Reference + `--plain` delta + 3 byte-identical SKILL.md copies) + release v1.23.0 (D-07, GEDGE-03/06 docs clause)
